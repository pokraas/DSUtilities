...
/**
 * Find all cyclic permutations that can be generated by applying one set of permutations (rows)
 * to another set of permutations (columns). Solves a typical DS exam task.
 * 
